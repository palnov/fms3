...
export const PUBLIC_ROUTES = [
  ...
  ["/pathways/vnzh/replacement", "monthly", 0.8],
  ...
  ["/pathways/work/employment-contract", "monthly", 0.8],
  ...
  ["/legal/registration-expired", "monthly", 0.85],
  ["/legal/controlled-persons-register", "weekly", 0.9],
  ["/legal/controlled-persons-register/removal", "monthly", 0.85],
