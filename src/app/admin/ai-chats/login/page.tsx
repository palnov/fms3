  ...
  return (
    <main className="min-h-screen bg-slate-950 px-6 py-10 text-slate-100">
      <div className="mx-auto max-w-md rounded-lg border border-slate-800 bg-slate-900 p-6 shadow-xl">
        ...
        <form action="/admin/ai-chats/login/submit" method="post" className="mt-6 space-y-4">
          <label className="block">
            ...
            <input
              ...
              className="mt-2 w-full rounded-md border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 outline-none focus:border-blue-500"
              required
            />
          </label>
